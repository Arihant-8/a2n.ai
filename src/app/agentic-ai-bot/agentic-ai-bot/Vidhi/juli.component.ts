...
@Component({
  ...
  templateUrl: './juli.component.html',
  styleUrls: ['./juli.component.scss']
})
export class JuliComponent implements AfterViewChecked {
  @ViewChild('juliWindow') chatWindow!: ElementRef;

  // messages: ChatMessage[] = [
  //   {
  //     sender: 'bot',
  //     name: 'Nova',
  //     text: 'Hi there 👋 I’m Nora, your AI assistant!',
